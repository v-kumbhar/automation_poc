Feature: Performance of MXReportes application and actions
 ...
 Background: 
  ...
  Scenario: Verify MXReports Performance page load time and time required to performe differnt actions on performance page
    Given He is on MXReports Performance Tab with default filter applied
